    ...
    <Dialog open={isOpen} onClose={onRequestClose}>
      ...
      <div className="items-center text-center" onClick={onRequestClose}>
        <div className="fixed inset-0 flex items-center justify-center">
          {/* 네모틀 */}
          <div
            className="relative mx-auto rounded-lg max-w-3xl w-full h-auto max-h-[80vh] p-6 bg-[#ffe69c]"
            onClick={(event) => {
          ...
          >
            ...
            {modals.length > 0 ? (
              <div className="text-center items-center p-2">
                ...
                <table
                  className="min-w-full divide-y divide-black border-collapse 
                    border border-black mb-2 text-center"
                >
                  <thead>
                    <tr className="font-bold">
                      <td className="p-2 border border-black bg-[#ffb247]">
                        제목
                      </td>
                      <td className="p-2 border border-black bg-[#ffb247]">
                        인코딩 일자
