...
import { PC_INVENTORY, SIGNAGE_INVENTORY,  API_BOARD, FILESIZE_FORM, NOTICE_BOARD, IMAGE_BOARD } from "../../constants/page_constant";
      ...
      <div>
        ...
        <div className="menu--list">
          ...
          <div
            ...
            {openMenu === "profile" && (
              <div className="submenu ml-8 mt-2">
                <Link  to={IMAGE_BOARD} className="flex items-center block py-1 mt-3 hover:bg-[#fe6500]/30 rounded cursor-pointer">
