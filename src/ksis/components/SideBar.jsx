...
const Sidebar = ({ onToggleSidebar }) => {
  ...
  return (
    <div className="bg-gray-100 text-black fixed top-0 left-0 h-full w-64 p-4 flex flex-col"
         onClick={(e) => {
           if (e.target === e.currentTarget && windowWidth > 1024) {  // 사이드바의 빈 공간을 클릭했을 때만 작동
             toggleExpand();
           }
         }}>
      {/* 알림 모달 창 표시 */}
          ...
          <div>
                  ...
                  {openMenu === "account" && (
                      <div className="submenu ml-8 mt-2">
                        ...
                        >
                          <FaRegCircle size={10} className="mr-2"/>
                          <span
                              className="absolute left-full hidden group-hover:block mr-2 bg-black text-white p-1 text-sm rounded whitespace-nowrap">
                            로그 기록
                          </span>
                        </Link>
                      </div>
            ...
            <div className="mt-3">
              ...
              >
                <MdChat className="mr-3"/>
                <span
                    className="absolute left-full hidden group-hover:block ml-2 bg-black text-white p-1 text-sm rounded whitespace-nowrap">공지글 관리</span>
              </Link>
            </div>
            ...
            <div className="item mt-3">
              ...
              >
                <MdDevices className="mr-3"/>
                <span
                    className="absolute left-full hidden group-hover:block ml-2 bg-black text-white p-1 text-sm rounded whitespace-nowrap">디바이스 관리</span>
              </div>
              {openMenu === "device" && (
                  <div className="submenu ml-8 mt-2">
                    <Link
            ...
            <div className="item mt-3">
              ...
              >
                <BiCog className="mr-3"/>
                <span
                    className="absolute left-full hidden group-hover:block ml-2 bg-black text-white p-1 text-sm rounded whitespace-nowrap">기타 관리</span>
              </div>
              {openMenu === "settings" && (
                  <div className="submenu ml-8 mt-2">
                    <Link
            ...
            <div className="item mt-3">
              ...
              >
                <BiTrash className="mr-3"/>
                <span
                    className="absolute left-full hidden group-hover:block ml-2 bg-black text-white p-1 text-sm rounded whitespace-nowrap">휴지통</span>
              </div>
              {openMenu === "trash" && (
                  <div className="submenu ml-8 mt-2">
                    <Link
